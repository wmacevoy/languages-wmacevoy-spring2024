...
static const char *const yytname[] =
{
  ...
  "DIV", "LP", "RP", "NUM", "ID", "EOL", "$accept", "start", "program",
  "statement", "e", "t", "f", YY_NULLPTR
};
...
{
      13,     1,    11,     2,     3,    15,    12,    13,    14,    10,
      16,     0,    17,     0,    18
};

static const yytype_int8 yycheck[] =
{
       3,     7,     0,     9,    10,     8,    11,     3,     5,     1,
      12,    -1,    13,    -1,    14
};
...
{
       0,     7,     9,    10,    13,    14,    15,    16,    17,    18,
      16,     0,    11,     3,     5,     8,    15,    17,    18
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, calc::Parser *parser)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (parser);
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, calc::Parser *parser)
{
  YY_USE (yyvaluep);
  YY_USE (parser);
  if (!yymsg)
...
yypush_parse (yypstate *yyps,
              int yypushed_char, YYSTYPE const *yypushed_val, calc::Parser *parser)
{
...
#line 29 "src/parser.y"
                           { parser->result = std::get<ParseTree::Ptr>(yyvsp[0]); }
#line 1162 "src/parser.cpp"
    break;

  case 3: /* program: program EOL statement  */
#line 32 "src/parser.y"
                           { yyval = ParseTree::program_ps(yyvsp[-2],yyvsp[-1],yyvsp[0]); }
#line 1168 "src/parser.cpp"
    break;

  case 4: /* program: statement  */
#line 33 "src/parser.y"
                           { yyval = ParseTree::program_s(yyvsp[0]); }
#line 1174 "src/parser.cpp"
    break;

  case 5: /* statement: %empty  */
#line 37 "src/parser.y"
      { yyval = ParseTree::statement_empty(); }
#line 1180 "src/parser.cpp"
    break;

  case 6: /* statement: e  */
#line 38 "src/parser.y"
      { yyval = ParseTree::statement_e(yyvsp[0]); }
#line 1186 "src/parser.cpp"
    break;

  case 7: /* e: e ADD t  */
#line 41 "src/parser.y"
            { yyval = ParseTree::e_add(yyvsp[-2],yyvsp[-1],yyvsp[0]); }
#line 1192 "src/parser.cpp"
    break;

  case 8: /* e: t  */
#line 42 "src/parser.y"
            { yyval = ParseTree::e_t(yyvsp[0]); }
#line 1198 "src/parser.cpp"
    break;

  case 9: /* t: t MUL f  */
#line 45 "src/parser.y"
            { yyval = ParseTree::t_mul(yyvsp[-2],yyvsp[-1],yyvsp[0]); }
#line 1204 "src/parser.cpp"
    break;

  case 10: /* t: f  */
#line 46 "src/parser.y"
            { yyval = ParseTree::t_f(yyvsp[0]); }
#line 1210 "src/parser.cpp"
    break;

  case 11: /* f: NUM  */
#line 49 "src/parser.y"
            { yyval = ParseTree::f_num(yyvsp[0]); }
#line 1216 "src/parser.cpp"
    break;

  case 12: /* f: ID  */
#line 50 "src/parser.y"
            { yyval = ParseTree::f_id(yyvsp[0]); }
#line 1222 "src/parser.cpp"
    break;

  case 13: /* f: LP e RP  */
#line 51 "src/parser.y"
            { yyval = ParseTree::f_e(yyvsp[-2],yyvsp[-1],yyvsp[0]); }
